...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.getString("xmpp_jid", null) != null &&
                preferences.getString("xmpp_pass", null) != null){
            showProgress(true);

            Intent i = new Intent(this, ChatConnectionService.class);
            startService(i);
        }
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //showProgress(true);
            Log.e(TAG, "Jid and pass are valid,so let's login");
    ...
    private void saveCredentialsAndLogin(){
        ...
        preferences
                .edit()
                .putString("xmpp_jid", mEmailView.getText().toString())
                .putString("xmpp_pass", mPasswordView.getText().toString())
